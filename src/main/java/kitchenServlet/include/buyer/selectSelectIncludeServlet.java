package kitchenServlet.include.buyer;
 ...
 */
@WebServlet("/selectSelectBrandServletB")
public class selectSelectIncludeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String goodsNumber=request.getParameter("Gno");
            ResultSet rs=db.selectUpdateInclude(goodsNumber);
