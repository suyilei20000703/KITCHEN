 ...
 */
@WebServlet("/selectmanagementServlet")
public class selectManagementServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public selectManagementServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            ResultSet rs=db.selectManagement();
             ...
             rs.close();
             response.sendRedirect("kitchen/management/admin_high/selectS.jsp");
        }catch(Exception e){
            e.printStackTrace();
        }
